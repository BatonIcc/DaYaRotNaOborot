...
def profile():
    ...
    user_data = {
        ...
        'avatar': User.query.get(current_user.id).get_avatar_filename()
    }
    ...
    if request.form.get('UserToken') and token_form.validate_on_submit():
        ...
        return render_template('profile.html', token_form=token_form,  password_form=password_form,
                               username_form=username_form, token_correct=True, user_data=user_data)
        ...
        if user:
            ...
            db.session.commit()
            return render_template('profile.html', token_form=token_form, password_form=password_form,
                                   username_form=username_form, pass_correct=True, user_data=user_data)
        ...
        if user:
            ...
            db.session.commit()
            return render_template('profile.html', token_form=token_form, password_form=password_form,
                                   username_form=username_form, username_correct=True, user_data=user_data)

    return render_template('profile.html', token_form=token_form, password_form=password_form,
                           username_form=username_form, user_data=user_data)
...
def get_user_data(id):
    ...
    return {
        ...
        'avatar': user.get_avatar_filename()
    }